...
//        T1_2_1.setText("9");
            ...
            T1_2_1.setTextColor(getResources().getColor(R.color.grayFont));
            if (isFirst){
                T1_2_1.setTextColor(getResources().getColor(R.color.grayFont));
            }
//        T1_2_2.setText("10月");
            T1_2_2.setTextSize(8);
            T1_2_2.setTextColor(getResources().getColor(R.color.grayFont));
            if (isFirst){
                T1_2_2.setTextColor(getResources().getColor(R.color.grayFont));
            }
//        T2_3.setText("周日");
            T2_3.setTextSize(16);
            T2_3.setTextColor(getResources().getColor(R.color.grayFont));
            if (isFirst){
                T2_3.setTextColor(getResources().getColor(R.color.grayFont));
            }
//        T2_2.setText("全天事件");
...
//        T1_1_2.setText("下午6:00到7:00");
            ...
            WwHm = new LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT); //3-1
            ...
            for(int i = 0 ; i < value.size() ; i++) {
                ...
                if (tempTodo.isAllDay == 0){
                    ...
                    System.out.println("query------->" + "hour:"+hour+"***minute:"+minute+"***time"+time);
                    if(hour >= 13 && hour <= 23){
                        hour-=12;
                        time = "下午 "+hour +":"+ minute;
                    }
        ...
        /*首页cardview图片相关*/
        ImageView nextTodo_i = (ImageView)view.findViewById(R.id.topPic0);
        Picasso.with(getActivity())
                .load(R.drawable.todo5)
                .fit()
                .into(nextTodo_i);
    ...
    public LinearLayout setAllDayTodo(String todo){
        ...
        lLyout2_2 = new LinearLayout(getActivity());
        lLyout2_2.setBackground(getResources().getDrawable(R.drawable.shape_todocard4));
        if (isF){
    ...
    public LinearLayout setNoAllDayTodo2(String todo, String time){
        ...
        if (isF){
            lLyout2_1.setBackground(getResources().getDrawable(R.drawable.todo16));
            isF = false;
        }
        lLyout2_1.setPadding(convertDipOrPx(getActivity(),8),convertDipOrPx(getActivity(),8),convertDipOrPx(getActivity(),8),convertDipOrPx(getActivity(),8));
